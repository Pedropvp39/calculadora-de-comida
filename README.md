...
Projeto criado com o intuito de fazer calculos pré-definidos.Permite registrar valores pré-definidos,calcular os valores e então dar o valor final.Feito com o intuito de mostrar a um profissinal da instituição do Senac-DF.O objetivo e praticar HTML,CSS,JavaScript e manipulação de DOM.
...
* Aumentar a pagina
# Aprendizagem 
Na criação desta pagina foi possivel aprender a manipular mais o JavaScript,CSS e HTML além da manipulação do DOM.Tambem foi possivel compreender melhor a organizar os itens da criação da pagina e como funcionan as funções do JavaScript para o calculo.
...
* "https://github.com/Pedropvp39/calculadora-de-comida.git"
# Autor
| Campo | Informação |
| :--- | :--- |
