document.addEventListener('DOMContentLoaded', () => {
    ...
    // Busca e armazena referências aos elementos HTML
    ...
    const calcularBtn = document.querySelector('#calcular-total-btn'); // Botão para recalcular o total

    // 2. Funções de Lógica
    
    /**
     * Calcula a soma total de todos os itens na lista de pedidos
     * e atualiza o <span> de valor total na tela.
     */
    function atualizarTotal() {
        ...
        // Formata o valor final para exibição no formato R$ 0,00
